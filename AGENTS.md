...
This directory is a generated `august` printed CLI. It was produced by [CLI Printing Press](https://github.com/AIF-Of-Counsel/august-cli), so treat systemic fixes as upstream Printing Press fixes first. Keep local edits narrow and document why a generated-tree patch belongs here.
...
```bash
august doctor --json
august agent-context --pretty
```

Use runtime discovery instead of relying on a copied command list:

```bash
august which "<capability>" --json
august <command> --help
```
...
```json
{
  ...
  "upstream_issue": "https://github.com/AIF-Of-Counsel/august-cli/issues/<n>"
}
```
