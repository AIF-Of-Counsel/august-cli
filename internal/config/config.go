...
type Config struct {
	...
	Path             string            `toml:"-"`
	AugustBearerAuth string            `toml:"bearer_auth"`
}

func Load(configPath string) (*Config, error) {
	cfg := &Config{
		BaseURL: "https://api.august.law",
	}
	...
	// Env var overrides
	if v := os.Getenv("AUGUST_API_KEY"); v != "" {
		cfg.AugustBearerAuth = v
		cfg.AuthSource = "env:AUGUST_API_KEY"
	} else if v := os.Getenv("AUGUST_BEARER_AUTH"); v != "" {
		cfg.AugustBearerAuth = v
		cfg.AuthSource = "env:AUGUST_BEARER_AUTH"
	}
	...
	if cfg.AuthSource == "" && cfg.AugustBearerAuth != "" {
		cfg.AuthSource = "config"
	}
...
func (c *Config) AuthHeader() string {
	...
	if c.AugustBearerAuth != "" {
		if c.AuthSource == "" {
			c.AuthSource = "env:AUGUST_BEARER_AUTH"
		}
		return "Bearer " + c.AugustBearerAuth
	}
	if c.AccessToken != "" {
