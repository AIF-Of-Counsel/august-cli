...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "august-pp-cli",
		Short: "Manage august resources via the august API",
		Long: `Manage august resources via the august API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'august-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("august-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'august-pp-cli profile list')")
	...
	rootCmd.AddCommand(newPreSharePoliciesCmd(flags))
	...
	rootCmd.AddCommand(newContentSearchPromotedCmd(flags))
