		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if cfg != nil {
				...
				if header == "" {
					...
					report["auth_hint"] = "export AUGUST_BEARER_AUTH=<your-key>"
					report["auth_docs_url"] = "https://august.law"
				} else {
					authConfigured = true
			...
			if os.Getenv("AUGUST_BEARER_AUTH") != "" {
				authEnvSet = append(authEnvSet, "AUGUST_BEARER_AUTH")
				...
				authEnvRequiredMissing = append(authEnvRequiredMissing, "AUGUST_BEARER_AUTH")
			}
			switch {
