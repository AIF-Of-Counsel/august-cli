...
but do not stop the import.`,
  ...
  august-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  august-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | august-pp-cli import <resource> --input -`,
